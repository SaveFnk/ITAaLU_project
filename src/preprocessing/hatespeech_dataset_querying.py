...
if __name__ == "__main__":
    ...
    #     "tvNfSsfe4BUmb4WpSgNvjCOgp",
    #     "fht6yjyatrD5VjF4O8XMRsOmUyPWV7Mz6XVZWfvLuAGitlWzF2",
    #     "0sln1dhjHtl7lYAvCJkPXLk8mnL67Zsx7kFgahhB3CPwmjKLGa",
    #     "RP0XR8kUanyMdXcCz69fVAMXpAH6bPJeb2JA3LAEXOcSA"
    # )

    client = tweepy.Client("AAAAAAAAAAAAAAAAAAAAAKc2tQEAAAAAWAwcDe8CO8AgCYaJNvzJPuqDbJg%3DDTSwMyQexggSTc2JpLxWK6K8LNzz8mtrT2krALvrCcIfAosNKD")

    public_tweets = client.get_tweets(["1344792819660189696", "1344767690225954816"])
